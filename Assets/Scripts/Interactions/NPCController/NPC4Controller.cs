...
public class NPC4Controller : MonoBehaviour, Interactable
{
    ...
    {
        if (DialogManager.Instance != null && GameManager.Instance.HasWonPuzzleGame)
        {
    ...
    private void OnDialogComplete()
    {
        ...
        GameManager.Instance.HasTalkToGang4 = true;
    }
}
