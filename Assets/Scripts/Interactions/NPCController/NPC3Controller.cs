...
public class NPC3Controller : MonoBehaviour, Interactable
{
    ...
    {
        if (DialogManager.Instance != null && GameManager.Instance.HasWonNewsNinjaGame)
        {
    ...
    private void OnDialogComplete()
    {
        ...
        GameManager.Instance.HasTalkToGang3 = true;
    }
}
