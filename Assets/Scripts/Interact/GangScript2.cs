...
public class GangScript2 : MonoBehaviour, Interactable
{
    ...
    {
        if (DialogManager.Instance != null && GameManager.Instance.HasTalkToGang1)
        {
    ...
    private void OnDialogComplete()
    {
        ...
        GameManager.Instance.HasTalkToGang2 = true;
    }
}
